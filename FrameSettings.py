...
class FrameSettings:
    ...
    def __init__(self, root, images):
        ...
        entry_x0 = Entry(self.frame, textvariable=self.string_x0)
        entry_x0.pack()
        ...
        entry_y0 = Entry(self.frame, textvariable=self.string_y0)
        entry_y0.pack()
        ...
        entry_tox = Entry(self.frame, textvariable=self.string_tox)
        entry_tox.pack()
        ...
        button_reset = Button(self.frame, text='Reset', font=('impact', 13), command=self.reset_settings, background='blue')
